...
<!-- Project Header -->
<header class="relative overflow-hidden px-6 py-24 md:py-32" in:fade={{ duration: 400 }}>
	...
	<article class="px-6 py-20 md:py-28">
		<div class="mx-auto max-w-2xl">
			...
			<section class="mb-16" in:fly={{ y: 20, duration: 500, delay: 100 }}>
				<p class="mb-2 text-xs font-medium tracking-widest text-ink-subtle uppercase">
					01 — Context
				</p>
